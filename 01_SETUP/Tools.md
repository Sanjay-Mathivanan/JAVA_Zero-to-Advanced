# 🛠️ Software Tools Catalog for Java Development
...
| :--- | :--- | :--- |
| **JDK Distribution** | Oracle JDK or Eclipse Temurin (LTS 17/21) | Core platform runtime & development compiler tools. |
...
| **Package Manager** | Homebrew | The missing package manager for macOS; simplifies tool maintenance. |
...
* **Git & GitHub**: Used for source code versioning, branch management, and repository backups.
